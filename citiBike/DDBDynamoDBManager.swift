...
class DDBDynamoDBManger : NSObject {
    ...
    class func createTable() -> AWSTask {
        ...
        hashKeyAttributeDefinition.attributeName = "GroupId"
        ...
        rangeKeySchemaElement.attributeName = "GroupTitle"
        rangeKeySchemaElement.keyType = AWSDynamoDBKeyType.Range
        
        //Add non-key attributes
        let passwordAttrDef = AWSDynamoDBAttributeDefinition()
        passwordAttrDef.attributeName = "Password"
        passwordAttrDef.attributeType = AWSDynamoDBScalarAttributeType.S
        
        let latAttrDef = AWSDynamoDBAttributeDefinition()
        latAttrDef.attributeName = "Lat"
        latAttrDef.attributeType = AWSDynamoDBScalarAttributeType.N
        
        let logAttrDef = AWSDynamoDBAttributeDefinition()
        logAttrDef.attributeName = "Log"
        logAttrDef.attributeType = AWSDynamoDBScalarAttributeType.N
        ...
        let rangeKeyArray = ["Password","Lat","Log"]
        ...
        for rangeKey in rangeKeyArray {
            ...
            gsiHashKeySchema.attributeName = "GroupTitle"
        ...
        createTableInput.attributeDefinitions = [hashKeyAttributeDefinition, rangeKeyAttributeDefinition, passwordAttrDef, latAttrDef,logAttrDef]
